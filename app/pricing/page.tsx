...
const plans = [
  ...
  },
  {
    ...
    features: ['Unlimited postów', 'Brand Kit (kolory, ton, głos marki)', 'Generowanie obrazów AI', 'Kalendarz treści z polskimi okazjami', 'Historia i ulubione posty', 'Automatyczna publikacja (Facebook, Instagram, TikTok)', 'Integracja ze sklepem (Baselinker / Shoper / Allegro)', 'Eksport CSV'],
    featured: true,
  ...
  const comparisonRows = [
    ...
    { feature: 'Automatyczna publikacja (FB / IG / TikTok)', starter: '✓', pro: '✓' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: '#f0f0f5', fontFamily: 'var(--font-dm-sans), sans-serif' }}>
      <style>{`
        ...
        .pricing-card { transition: transform 0.4s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.4s ease, box-shadow 0.4s ease; will-change: transform; }
