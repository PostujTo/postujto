...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://*.clerk.com https://img.clerk.com https://*.googleusercontent.com https://replicate.delivery https://*.replicate.com https://*.tidio.co https://*.tidio.com https://cdnjs.cloudflare.com",
